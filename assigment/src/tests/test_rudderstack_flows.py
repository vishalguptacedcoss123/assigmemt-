...
Run all tests:
pytest -v --env dev --base-url https://app.rudderstack.com --email your@company.com --password 'yourpass'
Run a specific test:
pytest src/tests/test_rudderstack_flows.py::test_rudderstack_basic_flow -v --env qa --base-url https://app.rudderstack.com --email your@company.com --password 'yourpass'
"""
